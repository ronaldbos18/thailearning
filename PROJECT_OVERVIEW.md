...
- Server-owned practice decisions: question selection, signed question tokens, distractors, answer checking, progress updates, XP, review scheduling, and streak updates.
