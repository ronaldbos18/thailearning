...
- Server-owned practice decisions: question selection, signed question tokens, database-backed replay protection, transactionally locked progress/XP updates, distractors, answer checking, review scheduling, and streak updates.
